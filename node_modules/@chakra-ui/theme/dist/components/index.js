...
var variantOutline3 = definePartsStyle11((props) => {
  ...
  return {
    field: {
      ...
      _invalid: {
        borderColor: (0, import_theme_tools7.getColorVar)(theme, ec),
        boxShadow: `0 0 0 1px ${(0, import_theme_tools7.getColorVar)(theme, ec)}`
      },
      _focusVisible: {
        zIndex: 1,
        borderColor: (0, import_theme_tools7.getColorVar)(theme, fc),
        boxShadow: `0 0 0 1px ${(0, import_theme_tools7.getColorVar)(theme, fc)}`
      }
    },
    addon: {
      border: "1px solid",
...
var variantFlushed = definePartsStyle11((props) => {
  ...
  return {
    field: {
      ...
      _invalid: {
        borderColor: (0, import_theme_tools7.getColorVar)(theme, ec),
        boxShadow: `0px 1px 0px 0px ${(0, import_theme_tools7.getColorVar)(theme, ec)}`
      },
      _focusVisible: {
        borderColor: (0, import_theme_tools7.getColorVar)(theme, fc),
        boxShadow: `0px 1px 0px 0px ${(0, import_theme_tools7.getColorVar)(theme, fc)}`
      }
    },
    addon: {
